...
namespace Medidata.RWS.NET.Standard.Core.Requests.Datasets
{
    /// <summary>
    /// Return the text of the full datasets listing for a subject as an ODM string.
    /// </summary>
    /// <seealso cref="Medidata.RWS.NET.Standard.Core.Requests.Datasets.OdmDatasetBase" />
    public class SubjectDatasetRequest : OdmDatasetBase
    {
        ...
        public override string UrlPath()
        {
            ...
            return Url.Combine(queryParams.ToArray()).SetQueryParams(QueryString());
